...
public class RetrieveGamesTask extends AsyncTask<Void, Void, ArrayList<GameObject>>{
	...
	public RetrieveGamesTask (Activity a,ListView list, String url){
		activity = a;
		listview = list;
		requestUrl = url;
	...
	protected ArrayList<GameObject> doInBackground(Void... arg0) {
		...
		try {
			...
			return ParserUtil.JSONGameListParser.parseGameList(sb.toString());
